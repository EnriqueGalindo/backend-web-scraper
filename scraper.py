...
# -*- coding: utf-8 -*-
"""
Module docstring: Grabs the email, phone numbers, urls, and pictures off a website.
...
issue is that the phone numbers grabbed are not always phone numbers just numbers
that follow the same general pattern phone numbers do.
"""
